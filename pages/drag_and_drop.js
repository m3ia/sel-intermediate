// We've loaded all the usual webdrive objects, pasted in our page's URL, and
...
class DragAndDropPage {
  constructor(driver) {
    ...
    this.locators = {
      ...
      // we can see it has an ID of "draggable". We'll set that up as a
      // locator here.
  ...
  // Here's the method that will perform the drag-and-drop. It needs to be
  // asynchronous, of course.
  async dragDrop() {
    // First we find the draggable element, using the locator we defined above.
    // Then we find the droppable element.
    ...
    // To perform the drag-and-drop action, we need the driver
